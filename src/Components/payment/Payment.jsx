  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-8 m-10 mb-0   ">
        ...
        <hr className="col-start-2 col-span-7 pt-5 border-t-2 border-gray-400" />
        <div className="ml-20 col-start-2 col-span-2 ">반납방법</div>
        <div className="ml-20 col-start-4 col-span-2">결제방법</div>
        <div className="ml-24 col-start-6 col-span-2">대여의상 수</div>
        <div className=" col-start-8 ">결제금액</div>
        <hr className="col-start-2 col-span-7 mt-5 pt-5 border-t border-gray-400" />
      </div>
      ...
      <form onSubmit={handleSave}>
        <div className="grid grid-cols-8 m-10 mt-2">
          ...
          <select
            className="ml-4 p-1 col-start-2 col-span-2 border border-gray-100 outline-none"
            name="return_method"
          >
          ...
          <select
            className="ml-4 p-1 col-start-4 col-span-2 border border-gray-100 outline-none"
            name="payment_method"
          ...
          <div className="col-start-6 col-span-2 m-auto">{amount}</div>
          <div className="col-start-8 col-span-2 text-lg font-bold">
            {totalPrice} 원
          </div>
          <hr className="col-start-2 col-span-7 mt-5 pt-5 border-t border-gray-400" />
        </div>
        ...
        <div className="flex justify-end mr-10">
          ...
          <div className=" text-sm text-right inline-block align-middle">
            <Link
              className="w-24 h-8 rounded-sm bg-white border border-gray-400 text-gray-600"
              type="button"
              to={'/cart/'}
            >
