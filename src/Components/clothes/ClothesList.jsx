...
function ClothesList({ itemsPerPage = 9 }) {
  ...
  return (
    <div>
      ...
      <div className="pr-4 text-right  flex justify-end">
        <svg
          fill="#c0c0c0"
        ...
        <input
          className="text-xs w-44 h-8 border-b border-gray-400 outline-none"
          type="search"
          name="search"
          onChange={getQuery}
          placeholder=" 제목으로 검색"
      ...
      <div className="grid grid-cols-3 grid-rows-3 gap-4 my-12 ">
